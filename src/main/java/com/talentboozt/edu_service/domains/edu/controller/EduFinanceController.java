...
import com.talentboozt.edu_service.domains.edu.dto.finance.PayoutRequest;
import com.talentboozt.edu_service.domains.edu.dto.finance.RevenueSummaryDTO;
import com.talentboozt.edu_service.domains.edu.enums.EPayoutStatus;
...
import com.talentboozt.edu_service.domains.edu.model.ERefund;
...
import com.talentboozt.edu_service.domains.edu.service.EduFinanceService;
import com.talentboozt.edu_service.domains.edu.service.EduRefundService;
...
public class EduFinanceController {
    ...
    private final com.talentboozt.edu_service.domains.edu.service.StripeConnectService stripeConnectService;
    private final com.talentboozt.edu_service.domains.edu.repository.mongodb.EPayoutScheduleRepository scheduleRepository;

    public EduFinanceController(EduFinanceService financeService, EduRefundService refundService,
            com.talentboozt.edu_service.domains.edu.service.StripeConnectService stripeConnectService,
            com.talentboozt.edu_service.domains.edu.repository.mongodb.EPayoutScheduleRepository scheduleRepository) {
    ...
    @PreAuthorize("hasAuthority('ENTERPRISE_INSTRUCTOR') or hasAuthority('SELLER_FREE')")
    public ResponseEntity<com.talentboozt.edu_service.domains.edu.model.EPayoutSchedule> updateSchedule(
            @AuthenticatedUser String userId,
            @RequestBody com.talentboozt.edu_service.domains.edu.model.EPayoutSchedule schedule) {
    ...
    @GetMapping("/schedule")
    @PreAuthorize("hasAuthority('ENTERPRISE_INSTRUCTOR') or hasAuthority('SELLER_FREE')")
    public ResponseEntity<com.talentboozt.edu_service.domains.edu.model.EPayoutSchedule> getSchedule(
            @AuthenticatedUser String userId) {
