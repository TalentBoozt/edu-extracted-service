...
import com.talentboozt.edu_service.domains.edu.dto.coupon.CouponValidationResult;
import com.talentboozt.edu_service.domains.edu.enums.EPaymentMethod;
import com.talentboozt.edu_service.domains.edu.enums.EPaymentStatus;
...
import com.talentboozt.edu_service.domains.edu.model.ETransactions;
...
import com.talentboozt.edu_service.domains.edu.repository.mongodb.ETransactionsRepository;
...
import com.talentboozt.edu_service.domains.edu.enums.EHoldingStatus;
import com.talentboozt.edu_service.domains.edu.model.EHoldingLedger;
import com.talentboozt.edu_service.domains.edu.model.EAffiliates;
import com.talentboozt.edu_service.domains.edu.model.EBundles;
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EHoldingLedgerRepository;
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EAffiliatesRepository;
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EBundlesRepository;
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EEnrollmentsRepository;

import com.talentboozt.edu_service.domains.edu.acl.ReferralPort;
...
public class EduCoursePurchaseService {
    ...
    private final ReferralPort referralService;
    ...
    public Map<String, String> createCourseCheckoutSession(String userId, String courseId, String trackingCode,
        ...
        if (!Boolean.TRUE.equals(course.getPublished()) || course.getStatus() != com.talentboozt.edu_service.domains.edu.enums.ECourseStatus.PUBLISHED) {
        ...
        if (CHECKOUT_METADATA_TYPE.equals(type)) {
            ...
            if (tx.getPaymentStatus() != EPaymentStatus.SUCCESS) {
                ...
                if (affiliateId != null && !affiliateId.isEmpty()) {
                    ...
                    if (affiliate != null) {
                        ...
                        holdingLedgerRepository.save(EHoldingLedger.builder()
                                ...
                                .beneficiaryType(com.talentboozt.edu_service.domains.edu.enums.EBeneficiaryType.AFFILIATE)
                ...
                holdingLedgerRepository.save(EHoldingLedger.builder()
                        ...
                        .beneficiaryType(com.talentboozt.edu_service.domains.edu.enums.EBeneficiaryType.CREATOR)
                        .transactionId(tx.getId())
                        .courseId(tx.getCourseId())
                ...
                analyticsEventService.recordEvent(com.talentboozt.edu_service.domains.edu.enums.EAnalyticsEvent.PURCHASE, 
