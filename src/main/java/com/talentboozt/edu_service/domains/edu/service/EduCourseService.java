...
import com.talentboozt.edu_service.domains.edu.service.EduAnalyticsEventService;
import com.talentboozt.edu_service.shared.security.utils.SecurityUtils;
import com.talentboozt.edu_service.domains.edu.dto.course.CourseRequest;
import com.talentboozt.edu_service.domains.edu.enums.ECourseStatus;
...
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EEnrollmentsRepository;
...
public class EduCourseService {
    ...
    private final com.talentboozt.edu_service.domains.edu.repository.mongodb.EProfilesRepository profilesRepository;
    private final com.talentboozt.edu_service.domains.edu.repository.mongodb.ECourseSectionsRepository sectionRepository;
    private final com.talentboozt.edu_service.domains.edu.repository.mongodb.ELessonsRepository lessonRepository;
    private final com.talentboozt.edu_service.domains.edu.acl.SsoGatewayPort ssoGateway;
    ...
    public EduCourseService(ECoursesRepository courseRepository,
            ...
            com.talentboozt.edu_service.domains.edu.repository.mongodb.EProfilesRepository profilesRepository,
            com.talentboozt.edu_service.domains.edu.repository.mongodb.ECourseSectionsRepository sectionRepository,
            com.talentboozt.edu_service.domains.edu.repository.mongodb.ELessonsRepository lessonRepository,
            com.talentboozt.edu_service.domains.edu.acl.SsoGatewayPort ssoGateway,
    ...
    public ECourses getCourseById(String id) {
        ...
        analyticsEventService.recordEvent(com.talentboozt.edu_service.domains.edu.enums.EAnalyticsEvent.VIEW,
    ...
    public List<ECourses> getCoursesByCreator(String creatorId) {
        ...
        com.talentboozt.edu_service.shared.tenant.TenantContext ctx = com.talentboozt.edu_service.shared.tenant.TenantContext
                .getCurrent();
        ...
        for (EEnrollments e : results) {
            ...
            if (e.getUserId() != null) {
                ...
                if (e.getName() == null || "Learner".equals(e.getName()) || e.getEmail() == null) {
                    ssoGateway.findById(e.getUserId()).ifPresent(creds -> {
                        if (e.getName() == null || "Learner".equals(e.getName())) {
                            e.setName(creds.firstName() + " " + creds.lastName());
                        }
                        if (e.getEmail() == null) {
                            e.setEmail(creds.email());
                        }
                    });
                }
    ...
    public List<com.talentboozt.edu_service.domains.edu.model.ECourseSections> getFullCurriculum(String courseId) {
        List<com.talentboozt.edu_service.domains.edu.model.ECourseSections> sections = sectionRepository
                .findByCourseId(courseId);
        List<com.talentboozt.edu_service.domains.edu.model.ELessons> lessons = lessonRepository.findByCourseId(courseId);

        // Group lessons by sectionId for efficient population
        java.util.Map<String, List<com.talentboozt.edu_service.domains.edu.model.ELessons>> lessonMap = lessons.stream()
                .collect(Collectors.groupingBy(com.talentboozt.edu_service.domains.edu.model.ELessons::getSectionId));

        for (com.talentboozt.edu_service.domains.edu.model.ECourseSections section : sections) {
            section.setLessonDetails(lessonMap.getOrDefault(section.getId(), java.util.Collections.emptyList())
                    .stream()
                    .sorted(java.util.Comparator
                            .comparingInt(com.talentboozt.edu_service.domains.edu.model.ELessons::getOrder))
                    .collect(Collectors.toList()));
        }

        return sections.stream()
                .sorted(java.util.Comparator
                        .comparingInt(com.talentboozt.edu_service.domains.edu.model.ECourseSections::getOrder))
                .collect(Collectors.toList());
    }
