...
import com.talentboozt.edu_service.domains.edu.repository.mongodb.ECreatorFinanceSettingsRepository;
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EPayoutsRepository;
...
public class EduFinanceService {
    ...
    public EPayouts updatePayoutStatus(String payoutId, EPayoutStatus status, HttpServletRequest request)
        ...
        if (status == EPayoutStatus.COMPLETED) {
            ...
            if (payout.getMethod() == com.talentboozt.edu_service.domains.edu.enums.EPayoutMethod.STRIPE) {
