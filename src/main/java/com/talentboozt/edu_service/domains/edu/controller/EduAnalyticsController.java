...
import com.talentboozt.edu_service.domains.edu.dto.analytics.CreatorAnalyticsDTO;
import com.talentboozt.edu_service.domains.edu.dto.analytics.LearnerAnalyticsDTO;
import com.talentboozt.edu_service.domains.edu.service.EduAnalyticsDataService;
...
public class EduAnalyticsController {
    ...
    private final com.talentboozt.edu_service.domains.edu.service.EduFeatureFlagService featureFlagService;
    private final com.talentboozt.edu_service.domains.edu.service.EduAnalyticsEventService eventService;
    private final com.talentboozt.edu_service.domains.edu.service.EduAnalyticsAggregationService aggregationService;

    public EduAnalyticsController(EduAnalyticsDataService analyticsDataService, 
                                com.talentboozt.edu_service.domains.edu.service.EduFeatureFlagService featureFlagService,
                                com.talentboozt.edu_service.domains.edu.service.EduAnalyticsEventService eventService,
                                com.talentboozt.edu_service.domains.edu.service.EduAnalyticsAggregationService aggregationService) {
    ...
    public ResponseEntity<java.util.List<com.talentboozt.edu_service.domains.edu.model.EAnalyticsEvents>> getEventsByUser(@PathVariable String userId) {
