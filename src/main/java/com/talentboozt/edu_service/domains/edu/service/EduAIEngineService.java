...
import com.talentboozt.edu_service.domains.edu.dto.ai.AIGenerationRequest;
import com.talentboozt.edu_service.domains.edu.enums.EAIUsageType;
import com.talentboozt.edu_service.domains.edu.enums.LLMTaskType;
...
public class EduAIEngineService {
    ...
    public EduAIEngineService(EduAICreditService creditService, LLMRouter llmRouter, EduAccessGuardService accessGuard, com.talentboozt.edu_service.domains.edu.service.EduFeatureFlagService featureFlagService, EduAnalyticsEventService analyticsEventService) {
