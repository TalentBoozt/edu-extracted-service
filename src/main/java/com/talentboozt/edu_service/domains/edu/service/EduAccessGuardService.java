...
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EAiUsageRepository;
...
public class EduAccessGuardService {
    ...
    private com.talentboozt.edu_service.domains.edu.enums.ESubscriptionPlan getEffectivePlan(EUser user) {
        if (user.getRoles() != null) {
            for (com.talentboozt.edu_service.domains.edu.enums.ERoles r : user.getRoles()) {
                if (r == com.talentboozt.edu_service.domains.edu.enums.ERoles.ENTERPRISE_ADMIN ||
                    ...
                    return com.talentboozt.edu_service.domains.edu.enums.ESubscriptionPlan.ENTERPRISE;
                }
            }
        }
        return user.getPlan() != null ? user.getPlan() : com.talentboozt.edu_service.domains.edu.enums.ESubscriptionPlan.FREE;
    }
