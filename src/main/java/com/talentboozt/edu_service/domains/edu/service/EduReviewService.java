...
import com.talentboozt.edu_service.domains.edu.dto.engagement.ReviewRequest;
...
import com.talentboozt.edu_service.domains.edu.repository.mongodb.EReviewsRepository;
...
public class EduReviewService {
    ...
    public EReviews addReview(String courseId, String userId, ReviewRequest request) {
        ...
        // Track analytics
        analyticsEventService.trackEvent(userId, com.talentboozt.edu_service.domains.edu.enums.EAnalyticsEvent.REVIEW,
                metadata);
