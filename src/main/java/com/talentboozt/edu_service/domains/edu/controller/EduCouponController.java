...
import com.talentboozt.edu_service.domains.edu.service.EduCouponService;
...
public class EduCouponController {
    ...
    private final com.talentboozt.edu_service.shared.security.utils.SecurityUtils securityUtils;
    ...
    public ResponseEntity<Map<String, Object>> validateCoupon(
        ...
        com.talentboozt.edu_service.domains.edu.dto.coupon.CouponValidationResult result = couponService.applyCoupon(code, courseId, userId, currentPrice);
