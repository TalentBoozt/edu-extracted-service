...
public class EduFraudDetectionService {
    ...
    private final com.talentboozt.edu_service.domains.edu.repository.mongodb.EFraudFlagRepository fraudFlagRepository;

    public EduFraudDetectionService(ETransactionsRepository transactionsRepository,
            com.talentboozt.edu_service.domains.edu.repository.mongodb.EFraudFlagRepository fraudFlagRepository) {
    ...
    public void flagUser(String userId, String type, String severity, String description) {
        com.talentboozt.edu_service.domains.edu.model.EFraudFlag flag = com.talentboozt.edu_service.domains.edu.model.EFraudFlag
                .builder()
                .targetUserId(userId)
                .flagType(type)
                .severity(severity)
