...
import com.talentboozt.edu_service.domains.edu.dto.enrollment.EnrollmentRequest;
...
public class EduEnrollmentService {
    ...
    private final com.talentboozt.edu_service.domains.edu.repository.mongodb.ELessonsRepository lessonsRepository;
    ...
    public EduEnrollmentService(EEnrollmentsRepository enrollmentsRepository,
            ...
            com.talentboozt.edu_service.domains.edu.repository.mongodb.ELessonsRepository lessonsRepository,
            ...
            if (total > 0) {
                ...
                if (enrollment.getProgress() >= 100 && !Boolean.TRUE.equals(enrollment.getCompleted())) {
                    ...
                    analyticsEventService.recordEvent(
                            com.talentboozt.edu_service.domains.edu.enums.EAnalyticsEvent.COMPLETE,
    ...
    public EEnrollments completeEnrollment(String enrollmentId) {
        ...
        analyticsEventService.recordEvent(com.talentboozt.edu_service.domains.edu.enums.EAnalyticsEvent.COMPLETE,
                enrollment.getUserId(), enrollment.getCourseId(),
