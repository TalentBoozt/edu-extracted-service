...
import com.talentboozt.edu_service.domains.edu.service.EduProfileService;
...
public class EduProfileController {
    ...
    public ResponseEntity<com.talentboozt.edu_service.domains.edu.dto.profile.PublicProfileDTO> getPublicProfile(@PathVariable String userId) {
        return ResponseEntity.ok(profileService.getPublicProfile(userId));
    }

    @GetMapping("/public/org/{workspaceId}")
    public ResponseEntity<com.talentboozt.edu_service.domains.edu.dto.profile.EnterprisePortfolioDTO> getEnterprisePortfolio(@PathVariable String workspaceId) {
        return ResponseEntity.ok(profileService.getEnterprisePortfolio(workspaceId));
    }

    @GetMapping("/discovery/{id}")
    public ResponseEntity<com.talentboozt.edu_service.domains.edu.dto.profile.DiscoveryProfileDTO> discoverProfile(@PathVariable String id) {
